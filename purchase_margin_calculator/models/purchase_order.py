...
class PurchaseOrder(models.Model):
    ...
    def button_confirm(self):
        ...
        # Recalculate last cost for products in this PO
    ...
    def _record_price_history(self, templates):
        """Record price history entries for confirmed PO lines."""
        ...
        for order in self:
            for line in order.order_line:
                ...
                purchase_uom = line.product_uom_id
                ...
                # Keep only last 10 entries per template+company
                old = History.search([
                    ('product_tmpl_id', '=', tmpl.id),
                    ('company_id', '=', order.company_id.id),
